...
$ az ml model create --name caregiver-match-v3 \
  --path /match_ML_v3/models/xgboost.onnx
...
- [V2 상세 기술 보고서](./TECHNICAL_REPORT.md)
- [V2와 V1 비교](./MODEL_COMPARISON_V1_VS_V2.md)
- [데이터 생성 로직 (V3)](./match_ML_v3/data/generate_data_from_original.py)
- [모델 학습 로직 (V3)](./match_ML_v3/train_models_v3.py)
